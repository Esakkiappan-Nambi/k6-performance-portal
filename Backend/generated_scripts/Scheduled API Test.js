...
export default function () {
    ...
    // Scheduled Test | Frequency: once | Start: 2026-06-24T19:05 | End: 2026-06-24T19:07
    const variables = {};
    

    
        // Scheduler: wait until start time
        const scheduleStart = new Date("2026-06-24T19:05:00").getTime();
        if (Date.now() < scheduleStart) {
            const waitMs = scheduleStart - Date.now();
            console.log("Waiting until scheduled start:", "2026-06-24T19:05:00");
            sleep(waitMs / 1000);
        }

    
        // Scheduler: stop after end time
        const scheduleEnd = new Date("2026-06-24T19:07:00").getTime();
